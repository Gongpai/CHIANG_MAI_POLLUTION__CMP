...
public class DayNightCycle : MonoBehaviour
{
    ...
    [Header("Sun")] 
    public bool Is_Rotate_Sun = true;
    ...
    void MoveClouds()
    {
        RenderSettings.skybox.SetVector("_CloudsOffset", (Vector2)RenderSettings.skybox.GetVector("_CloudsOffset") + (TM.deltaTime * 0.002f) * cloudsSpeed);
    }
