...
{
    public class TechnologyResearchBuildingProductElementUIScript : EconomyBuildingProductElementUIScript
    {
        public override void Update_Building_Data()
        {
            Tuple<int, int> product = get_all_tech_product();
        ...
        private Tuple<int, int> get_all_tech_product()
        {
            int resource = 0;
            int max_resource = 0;
            ...
            {
                if (buildingSystemScript.job == PeopleJob.Engineer)
                {
